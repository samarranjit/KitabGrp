  ...
  return (
    <Box className="" display={"flex"} justifyContent={"center"} alignContent={"center"}>
        <Card sx={{ maxWidth: 345, width: "100%" }}>
          <CardMedia
            sx={{ height: 140 }}
            image={(book?.coverImage)?(book?.coverImage):"https://i.fbcd.co/products/resized/resized-750-500/ae2d64e634f5beaa6f0e867d529ece28f0504e9e24fc4d5e0d6fd21f0a05df7f.jpg"}
            title="green iguana"
          />
          <CardContent>
